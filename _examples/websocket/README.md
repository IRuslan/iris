...
[View or download sample code](https://github.com/IRuslan/iris/tree/master/_examples/websocket).
...
* import the `"github.com/IRuslan/iris/websocket"`
...
```go
import "github.com/IRuslan/iris/websocket"
```
