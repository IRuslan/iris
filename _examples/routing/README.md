...
Once the handler is registered, we can use the returned [`Route`](https://godoc.org/github.com/IRuslan/iris/core/router#Route) instance to give a name to the handler registration for easier lookup in code or in templates.
...
As mentioned in the [Handlers](handlers.md) chapter, Iris provides several handler registration methods, each of which returns a [`Route`](https://godoc.org/github.com/IRuslan/iris/core/router#Route) instance.
...
* [`GetRoutes`](https://godoc.org/github.com/IRuslan/iris/core/router#APIBuilder.GetRoutes) function to get all registered routes
* [`GetRoute(routeName string)`](https://godoc.org/github.com/IRuslan/iris/core/router#APIBuilder.GetRoute) method to retrieve a route by name
* [`URL(routeName string, paramValues ...interface{})`](https://godoc.org/github.com/IRuslan/iris/core/router#RoutePathReverser.URL) method to generate url string based on supplied parameters
* [`Path(routeName string, paramValues ...interface{}`](https://godoc.org/github.com/IRuslan/iris/core/router#RoutePathReverser.Path) method to generate just the path (without host and protocol) portion of the URL based on provided values

## Examples

Check out the [https://github.com/IRuslan/iris/tree/master/_examples/view/template_html_4](https://github.com/IRuslan/iris/tree/master/_examples/view/template_html_4) example for more details.
...
## [Explore](https://github.com/IRuslan/iris/tree/master/middleware)
...
The `iris.Context` source code can be found [here](https://github.com/IRuslan/iris/blob/master/context/context.go). Keep note using an IDE/Editors with `auto-complete` feature will help you a lot.
...
type Context interface {
    ...
    //
    // Example: https://github.com/IRuslan/iris/tree/master/_examples/miscellaneous/i18n
    ...
    //  `iris#WithPostMaxMemory` configurator at main configuration passed on `app.Run`'s second argument.
    //
    // Example: https://github.com/IRuslan/iris/tree/master/_examples/http_request/upload-file
    ...
    //
    //
    // Example: https://github.com/IRuslan/iris/tree/master/_examples/http_request/upload-files
    ...
    //
    // Example: https://github.com/IRuslan/iris/blob/master/_examples/http_request/read-custom-via-unmarshaler/main.go
    ...
    //
    // Example: https://github.com/IRuslan/iris/blob/master/_examples/http_request/read-json/main.go
    ...
    //
    // Example: https://github.com/IRuslan/iris/blob/master/_examples/http_request/read-xml/main.go
    ReadXML(xmlObjectPtr interface{}) error
    // ReadForm binds the formObject  with the form data
    // it supports any kind of struct.
    //
    // Example: https://github.com/IRuslan/iris/blob/master/_examples/http_request/read-form/main.go
    ...
    //
    // Example: https://github.com/IRuslan/iris/tree/master/_examples/view/context-view-data/
    ...
    //
    // Examples: https://github.com/IRuslan/iris/tree/master/_examples/view
    ...
    //
    // Example: https://github.com/IRuslan/iris/tree/master/_examples/cookies/basic
    ...
    //
    // See https://github.com/IRuslan/iris/tree/master/_examples/ for more
    ...
    //
    // Example: https://github.com/IRuslan/iris/tree/master/_examples/routing/route-state
    //
