...
[皆様の声](#支援)をご覧ください。このレポジトリを[Star](https://github.com/IRuslan/iris/stargazers)し、[最新情報](https://facebook.com/iris.framework)を受け取りましょう。
...
- バグを発見しましたか？[github issues](https://github.com/IRuslan/iris/issues)に投稿をお願い致します。
...
[全貢献者リスト](https://github.com/IRuslan/iris/graphs/contributors)
...
- より詳しく知るために[godocs](https://godoc.org/github.com/IRuslan/iris)を読む
...
> 似たようなものを開発しましたか？ [私たちにも教えてください！](https://github.com/IRuslan/iris/pulls)
