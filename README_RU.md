...
Узнайте, что [другие говорят об Iris](#support), и [запустите](https://github.com/IRuslan/iris/stargazers) этот github-хранилище, чтобы оставаться в курсе последних событий [актуальными](https://facebook.com/iris.framework).
...
- Вы случайно обнаружили ошибку? Опубликуйте ее на [Github вопросы](https://github.com/IRuslan/iris/issues)
...
[Список всех участников](https://github.com/IRuslan/iris/graphs/contributors)
...
- Прочтите [godocs](https://godoc.org/github.com/IRuslan/iris) для любых подробностей
...
> Вы построили что-то подобное? Дайте нам [знать](https://github.com/IRuslan/iris/pulls)!
